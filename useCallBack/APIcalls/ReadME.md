...
# Problem Statement:Optimized API calls:

Develop a component that fetches data from an API based on user actions. Use the useCallback hook to memoize the API call function, avoiding redundant API requests when certain conditions don't change.
