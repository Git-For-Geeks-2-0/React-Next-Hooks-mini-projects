...
# Problem Statement: Auto focus Input
Design a web page with an input field that automatically gains focus when the page loads. Achieve this functionality using the useRef hook in React.
