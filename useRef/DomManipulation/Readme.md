...
Design a web-based canvas drawing application that allows users to draw and paint on a canvas element using their mouse. The challenge here is to implement this using DOM manipulation and the useRef hook in React.
