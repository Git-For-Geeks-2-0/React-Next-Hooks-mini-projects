...
# Problem Statement: Color Picker
Design a simple web-based color picker application , with the state management handled using the useState hook. The color picker should allow users to choose a color and display it on the screen.
