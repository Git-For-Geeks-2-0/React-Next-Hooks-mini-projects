...
# Problem Statement:Progressive-Web App:
Design a Progressive Web App (PWA) that works offline or in low-connectivity scenarios. Use useEffect to handle caching and synchronization of data for offline use.
