...
Design a user profile page using React and the useContext hook. The user profile should display information about the user, such as their name, email, profile picture, and any other relevant details
