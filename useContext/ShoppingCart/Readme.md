...
# Problem Statement: Shopping Cart 
Design and implement a shopping cart application using useContext hook from React. The shopping cart should allow users to add products to their cart, view the cart's contents, update quantities, and remove items from the cart.
