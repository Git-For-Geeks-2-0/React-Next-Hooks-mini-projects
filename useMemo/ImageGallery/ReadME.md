...
# Problem Statement: Image Gallery with Memoized Filtering

Create an image gallery where users can filter images based on categories (e.g., nature, food, travel). Use useMemo to memoize the filtered image list to improve performance when filtering.
