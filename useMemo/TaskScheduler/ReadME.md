...
# Problem Statement: Task Scheduler with Memoized Task Counts:
Develop a task scheduler application where users can add, edit, and delete tasks. Use useMemo to memoize the count of completed and pending tasks, updating them only when tasks are added or completed.
