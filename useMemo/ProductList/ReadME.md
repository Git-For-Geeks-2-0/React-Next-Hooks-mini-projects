...
# Problem Statement:Product List with Memoized Price Calculation:

Build a product listing page where each product has different prices in different currencies. Use useMemo to memoize the price conversions based on the selected currency to avoid unnecessary recalculations.
